...
Demographic information (age, ethnicity, education) is listed in LISS background variables <https://doi.org/10.57990/qn3k-as78>, which is a collection of basic information that panel members can update as necessary each time that they take part in a LISS study. The dempographic variables used in this study are automatically appended to the data of studies (1-3) by LISS.
